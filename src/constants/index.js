...
const projects = [
  {
    name: "Spotify Clone",
    description:
      "Web-based platform that allows users to search, listen , and create their own playlists .Users can connect and chat with their friends and listen to their favorite music.",
    tags: [
      {
        name: "react",
